...
export function registerElementTools(server, revit) {
    server.tool("query_elements", "Query elements in the Revit model by category, family, type, level, or parameter values", {
        category: z
            .string()
            .optional()
    ...
    server.tool("get_element_by_id", "Get full details and all parameters for a specific Revit element by its element ID (supports 64-bit IDs for Revit 2024+)", {
        ...
        try {
            ...
            return {
                content: [
                    { type: "text", text: JSON.stringify(element, null, 2) },
                ],
            };
        }
        catch (err) {
...
//# sourceMappingURL=element-tools.js.map